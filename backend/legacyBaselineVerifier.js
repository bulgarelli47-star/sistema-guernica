...
const SCHEMA_TABLE_ENTRIES = [
  ...
  { id: "TABLE:detalle_venta_ingredientes", category: "SCHEMA_TABLE", table: "detalle_venta_ingredientes" },
  ...
  { id: "TABLE:produccion_componentes_snapshot", category: "SCHEMA_TABLE", table: "produccion_componentes_snapshot" },
  { id: "TABLE:producciones", category: "SCHEMA_TABLE", table: "producciones" },
...
const SCHEMA_COLUMN_ENTRIES = [
  ...
  { id: "COLUMN:stock_ajustes_pendientes.cantidad_pendiente_resolucion", category: "SCHEMA_COLUMN", table: "stock_ajustes_pendientes", column: "cantidad_pendiente_resolucion" },
  { id: "COLUMN:stock_ajustes_pendientes.cantidad_resuelta", category: "SCHEMA_COLUMN", table: "stock_ajustes_pendientes", column: "cantidad_resuelta" },
  { id: "COLUMN:stock_ajustes_pendientes.cantidad_teorica", category: "SCHEMA_COLUMN", table: "stock_ajustes_pendientes", column: "cantidad_teorica" },
  { id: "COLUMN:stock_ajustes_pendientes.componente_id", category: "SCHEMA_COLUMN", table: "stock_ajustes_pendientes", column: "componente_id" },
  { id: "COLUMN:stock_ajustes_pendientes.cuenta_local_costo_estimado", category: "SCHEMA_COLUMN", table: "stock_ajustes_pendientes", column: "cuenta_local_costo_estimado" },
  { id: "COLUMN:stock_ajustes_pendientes.cuenta_local_integracion", category: "SCHEMA_COLUMN", table: "stock_ajustes_pendientes", column: "cuenta_local_integracion" },
  { id: "COLUMN:stock_ajustes_pendientes.cuenta_local_nombre_snapshot", category: "SCHEMA_COLUMN", table: "stock_ajustes_pendientes", column: "cuenta_local_nombre_snapshot" },
  { id: "COLUMN:stock_ajustes_pendientes.cuenta_local_observacion", category: "SCHEMA_COLUMN", table: "stock_ajustes_pendientes", column: "cuenta_local_observacion" },
  { id: "COLUMN:stock_ajustes_pendientes.cuenta_local_responsable", category: "SCHEMA_COLUMN", table: "stock_ajustes_pendientes", column: "cuenta_local_responsable" },
  { id: "COLUMN:stock_ajustes_pendientes.detalle_venta_id", category: "SCHEMA_COLUMN", table: "stock_ajustes_pendientes", column: "detalle_venta_id" },
  { id: "COLUMN:stock_ajustes_pendientes.fecha_resolucion", category: "SCHEMA_COLUMN", table: "stock_ajustes_pendientes", column: "fecha_resolucion" },
  { id: "COLUMN:stock_ajustes_pendientes.hora_resolucion", category: "SCHEMA_COLUMN", table: "stock_ajustes_pendientes", column: "hora_resolucion" },
  { id: "COLUMN:stock_ajustes_pendientes.origen", category: "SCHEMA_COLUMN", table: "stock_ajustes_pendientes", column: "origen" },
  { id: "COLUMN:stock_ajustes_pendientes.producto_vendido_id", category: "SCHEMA_COLUMN", table: "stock_ajustes_pendientes", column: "producto_vendido_id" },
  { id: "COLUMN:stock_ajustes_pendientes.producto_vendido_nombre_snapshot", category: "SCHEMA_COLUMN", table: "stock_ajustes_pendientes", column: "producto_vendido_nombre_snapshot" },
  { id: "COLUMN:stock_ajustes_pendientes.resolucion_parcial", category: "SCHEMA_COLUMN", table: "stock_ajustes_pendientes", column: "resolucion_parcial" },
  { id: "COLUMN:stock_ajustes_pendientes.resuelto_por", category: "SCHEMA_COLUMN", table: "stock_ajustes_pendientes", column: "resuelto_por" },
  { id: "COLUMN:stock_ajustes_pendientes.tipo_resolucion", category: "SCHEMA_COLUMN", table: "stock_ajustes_pendientes", column: "tipo_resolucion" },
  { id: "COLUMN:stock_ajustes_pendientes.venta_id", category: "SCHEMA_COLUMN", table: "stock_ajustes_pendientes", column: "venta_id" },
...
const SCHEMA_INDEX_ENTRIES = [
  ...
  { id: "INDEX:idx_detalle_venta_ingredientes_detalle", category: "SCHEMA_INDEX", indexName: "idx_detalle_venta_ingredientes_detalle", table: "detalle_venta_ingredientes", columns: ["detalle_venta_id"], unique: false, partial: false, predicate: null },
  ...
  { id: "INDEX:idx_produccion_componentes_produccion", category: "SCHEMA_INDEX", indexName: "idx_produccion_componentes_produccion", table: "produccion_componentes_snapshot", columns: ["produccion_id"], unique: false, partial: false, predicate: null },
  { id: "INDEX:idx_producciones_fecha", category: "SCHEMA_INDEX", indexName: "idx_producciones_fecha", table: "producciones", columns: ["fecha"], unique: false, partial: false, predicate: null },
  { id: "INDEX:idx_producciones_producto", category: "SCHEMA_INDEX", indexName: "idx_producciones_producto", table: "producciones", columns: ["producto_id"], unique: false, partial: false, predicate: null },
