...
const CONFIGURACION_DEFAULTS = {
  ...
  modulo_finanzas_admin: { seccion: "usuarios_permisos", valor: true },
  modulo_finanzas_encargado: { seccion: "usuarios_permisos", valor: false },
  modulo_finanzas_colaborador: { seccion: "usuarios_permisos", valor: false },
  modulo_integraciones_admin: { seccion: "usuarios_permisos", valor: true },
  modulo_integraciones_encargado: { seccion: "usuarios_permisos", valor: false },
  modulo_integraciones_colaborador: { seccion: "usuarios_permisos", valor: false },
