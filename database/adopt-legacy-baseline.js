...
// ==== MT-1E2C2B.1/.2: wrapper de backup con Online Backup API + maquina de estados ====
// NO exportado. init/step/finish explicitos (db.backup(path, cb) SOLO inicializa -- confirmado
// contra node_modules/sqlite3/src/backup.cc). Estados: INITIALIZING -> COPYING -> FINISHING ->
// SETTLED, con un unico finalizador que llama backup.finish() como maximo una vez, sin importar
// el orden de llegada entre el callback de step y el evento 'error' del objeto Backup.
